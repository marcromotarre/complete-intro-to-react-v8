      ...
      <div className="grid grid-cols-[300px_auto]">
        ...
        <div className="grid grid-cols-1 gap-y-4 p-8">
          ...
          <p className="font-light">
            ...
            components. Traditionally, in React, state and lifecycle methods
            were managed in class components. Hooks provide a way to use these
            features in functional components, making them more powerful and
            easier to read and maintain. Hooks are built-in functions provided
            by React that you can use to add and manage state, perform side
            effects, and access the React lifecycle methods. There are several
          ...
          <p>useEffect</p>
          <p className="font-light">
            This hook is used to perform side effects, such as fetching data
            from an API or subscribing to events. It replaces lifecycle methods
          ...
          <p className="font-light">
            ...
            because the click count is only read and written in an event
            handler.
          </p>
          <Code>
            <>{useRefExampleCode}</>
          ...
          <p className="font-light">
            The most common use of useRef is to manipulate DOM elements. We
            gonna use useRef to setup a variable and then with the ref prop we
            are going to set the value of that variable.
          </p>
          <p className="font-light">
          ...
          <p className="font-light">
            We can use useMemo to cache the result of that operation and when
            the component rerenders will use the cached value instead of call
            the expensiveMathOperationAgain
          </p>
          <Code>
            <>{useMemoExample}</>
          </Code>
          ...
          <p>useLayoutEffect</p>
          <p className="font-light">
            Only use useLayoutEffect when you want to measure something in the
            DOM after its being rendered. Everything else you need use useEffect
          </p>
          <p className="font-light">
            The following code updates width and height variables after the
            textarea is resized
          </p>
          <div>
